...
@HiltViewModel
class AnxietyQuestionnaireViewModel @Inject constructor(
    ...
    override val fieldName = "anxietyQuestionnaireResults"
    override fun getResultMessageResource(score: Int?): Int? {
        return when {
            score == null -> null
            score in 0..7 -> R.string.negativeAnxietyTest
            score in 8..10 -> R.string.borderlineAnxietyTest
            else -> R.string.positiveAnxietyTest
        }
    }
}